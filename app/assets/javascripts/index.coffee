...
populateStockHistory = (message) ->
  ...
  chartHolder.append($("<p>").html("values are simulated."))
  ...
  $("#stocks").prepend('<a href="#" data-content="'+message.symbol+'" class="removeStock">Remove</a>')
